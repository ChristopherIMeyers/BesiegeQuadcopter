...
CurrentEnginePower := ThrottleSensitivity * inputThrottle

; for stick
TargetX := inputSlider * XYThrow
...
DesireToMoveEngine += ThrottleSensitivity * inputThrottle
DesireToTilt += RotateSensitivity * inputX

if (DesireToMoveEngine > 1) {
  DesireToMoveEngine += -1
  Send, t
}
